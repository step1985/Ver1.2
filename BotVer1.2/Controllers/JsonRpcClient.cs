...
namespace BotVer1._2.Controllers
{
    public class JsonRpcClient : HttpWebClientProtocol, IClient
    {
        ...
        public IList<MarketCatalogue> listMarketCatalogue(MarketFilter marketFilter, ISet<MarketProjection>
                                                          marketProjections, MarketSort marketSort,
                                                          string maxResult = "1", string locale = null)
        {
            var args = new Dictionary<string, object>();
        ...
        public T Invoke<T>(string method, IDictionary<string, object> args = null)
        {
            ...
            using (Stream stream = request.GetRequestStream()) // sometimes a mistake (no connect internet)
        ...
        private static System.Exception ReconstituteException(BotVer1._2.TO.Exception ex)
        {
            var data = ex.Data;
